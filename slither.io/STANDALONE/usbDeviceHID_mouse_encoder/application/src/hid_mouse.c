...
static void setRightButtonMouseReport(uint8_t *rep, uint8_t state)
{
	if (state) {
		rep[0] |= 0x02;
	}
...
/* codigo muy chancho pues es prueba de concepto */

static void Mouse_UpdateReport0(void)
{
   Mouse_UpdateReport(0,0);
